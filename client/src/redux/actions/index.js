...
export const fetchWorkoutsSuccess = (workouts) => ({ type: types.FETCH_WORKOUTS_SUCCESS, workouts })
export const fetchWorkoutsFailure = (error) => ({ type: types.FETCH_WORKOUTS_FAILURE, error })

export const fetchWorkout = (id) => ({ type: types.FETCH_WORKOUT, id })
export const fetchWorkoutSuccess = (workout) => ({ type: types.FETCH_WORKOUT_SUCCESS, workout })
export const fetchWorkoutFailure = (error) => ({ type: types.FETCH_WORKOUT_FAILURE, error })
/** End workout actions */
